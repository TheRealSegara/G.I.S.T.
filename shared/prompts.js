...
export const STAGE3_CYCLE = ["tap_select", "reverse_clue"]; // a wrong word to tap, or a supporting sentence to find elsewhere in the passage
...
Stage 3: for input_type "${stage3Type}" this session, ${
  stage3Type === "reverse_clue"
    ...
    : "Fix-mistake: sentence uses the word slightly WRONG (form or context); student TAPS the one wrong word to flag it, never types a correction."
}
...
Respond with ONLY valid, compact, single-line JSON, no markdown fences, no extra commentary, no literal line breaks inside any string value, in exactly this shape:
{
  ...
  "options": ["a","b","c","d"] or null — exactly 4 for mcq, exactly ["True","False"] for true_false, 3-6 (a curated subset, see above) for tap_select, exactly 3 full verbatim passage sentences for reverse_clue (see above), null otherwise,
